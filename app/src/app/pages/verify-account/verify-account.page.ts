...
export class VerifyAccountPage implements OnInit, OnDestroy {
    ...
    constructor(private menu: MenuService, private toast: ToastService, private router: Router, private service: AccountService, private formerror: FormErrorService, private localstorage: LocalstorageService) {};
    ...
    public async submit() {
        ...
        if (response.ok) {
            ...
            this.toast.success('verification was successful!');
        } else {
